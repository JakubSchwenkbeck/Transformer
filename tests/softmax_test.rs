...
pub fn test_softmax_vector(){
        ...
        let expected : Array1<f32> = Array1::from(vec![0.0021656966, 0.0058869733, 0.11824302, 0.87370431]);
...
pub fn test_softmax_matrix(){
    ...
    let expected1 : Array2<f32> =  array![[0.0900305732,0.2447284711,0.6652409558],[ 0.0900305732,0.2447284711,0.6652409558],[0.0900305732,0.2447284711,0.6652409558]];
    ...
    let expected2: Array2<f32> =  array![[0.00032932044,0.0179802867,0.98169035],[ 0.0147534745,0.17973413,0.805512412],[0.0900305732,0.2447284711,0.6652409558]];
